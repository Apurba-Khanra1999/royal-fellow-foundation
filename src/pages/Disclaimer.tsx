            ...
            <CardContent className="p-8">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  The information is provided by RoyalFellowFoundation and while we endeavor to keep the information 
                ...
                <p className="text-muted-foreground mb-6">
                  RoyalFellowFoundation acts as a platform connecting users with professional service providers. 
                ...
                <p className="text-muted-foreground mb-6">
                  The content on RoyalFellowFoundation is not intended to be a substitute for professional medical 
                ...
                <p className="text-muted-foreground mb-6">
                  Any reliance you place on information from RoyalFellowFoundation is strictly at your own risk. 
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  control of RoyalFellowFoundation. We have no control over the nature, content and availability 
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  of individual users and do not reflect the views of RoyalFellowFoundation. We do not verify the 
                ...
                <p className="text-muted-foreground mb-6">
                  Every effort is made to keep the website up and running smoothly. However, RoyalFellowFoundation 
                ...
                <p className="text-muted-foreground mb-6">
                  RoyalFellowFoundation reserves the right to modify this disclaimer at any time. Changes will be 
                ...
                <p className="text-muted-foreground">
                  ...
                  <br />
                  Email: info@royalfellowfoundation.com
                  <br />
