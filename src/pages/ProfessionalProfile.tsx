...
const ProfessionalProfile = () => {
  ...
  const professional = {
    ...
    officelocation: [
      "Konnagar, Kanaipur, Hooghly",
      "Appolo Clinic, Uttarpara",
      "Greenview Apartment, Howrah"
    ],
    services: [
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Back Button */}
        <Link to="/professionals" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-6">
                ...
                {selectedTab === "overview" && (
                  <div className="space-y-6">
                      ...
                      <ul className="space-y-2">
                        {professional.education.map((edu, index) => (
                          <li key={index} className="flex items-start">
                            <BookOpen className="h-4 w-4 mr-3 mt-1 text-blue-600" />
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {professional.officelocation.map((offi, index) => (
                          <li key={index} className="flex items-start">
                            <Navigation className="h-4 w-4 mr-3 mt-1 text-purple-600" />
                            <span className="text-gray-600">{offi}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <MapPin className="h-4 w-4 mr-3 mt-1 text-blue-600" />
